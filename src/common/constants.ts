...
export const MYSQL_DATABASE_HOST_NAME_KEY = 'USER_SERVICE_DB_HOST';
export const MYSQL_DATABASE_PORT_KEY = 'USER_SERVICE_DB_PORT';
export const MYSQL_DATABASE_USER_NAME_KEY = 'USER_SERVICE_DB_USERNAME';
export const MYSQL_DATABASE_PASSWORD_KEY = 'USER_SERVICE_DB_PASSWORD';
export const MYSQL_DATABASE_NAME_KEY = 'USER_SERVICE_DB_DATABASE';
