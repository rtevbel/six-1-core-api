...
export const MICROSERVICE_SCHEDULE_TASk_WINDOW_PATTERN =  'v0.1_scheduler_task_scheduleWindow';        
export const MICROSERVICE_SCHEDULE_TASk_FROM_SHIFT_PATTERN  =  'v0.1_scheduler_task_scheduleFromShifts';
...
export const MICROSERVICE_FIND_ALL_SCHEDULES_PATTERN = 'v0.1_scheduler_find_all';
export const MICROSERVICE_FIND_ONE_SCHEDULE_PATTERN = 'v0.1_scheduler_find_one';
export const MICROSERVICE_FIND_ALL_BY_TASK_PATTERN = 'v0.1_scheduler_find_all_by_task';
...
export const MICROSERVICE_CREATE_RESOURCE_ASSIGNMENT_PATTERN = 'v0.1_resource_assignment_create';
export const MICROSERVICE_FIND_ALL_RESOURCE_ASSIGNMENTS_PATTERN = 'v0.1_resource_assignment_find_all';
export const MICROSERVICE_FIND_ONE_RESOURCE_ASSIGNMENT_PATTERN = 'v0.1_resource_assignment_find_one';
export const MICROSERVICE_UPDATE_RESOURCE_ASSIGNMENT_PATTERN = 'v0.1_resource_assignment_update';
export const MICROSERVICE_REMOVE_RESOURCE_ASSIGNMENT_PATTERN = 'v0.1_resource_assignment_remove';
