...
export class FiltersDto {
   ...
   * Optional field, defaults to 'categoryId'.
   * Must be one of 'categoryId', 'languageId'.
   */
  @IsOptional()
  @IsIn(['categoryId', 'languageId'], {
    message: 'sortBy key must be from this list (categoryId, languageId)',
  })
  @IsString()
