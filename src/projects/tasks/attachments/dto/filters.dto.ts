...
export class FiltersDto {
  /**
   * Comment ID for filtering results.
   ...
   * Optional field, defaults to 'attachmentId'.
   * Must be one of 'attachmentId', 'taskId','commentId'.
   */
  @IsOptional()
  @IsIn(['attachmentId', 'taskId', 'commentId'], {
    message:
      'sortBy key must be from this list (attachmentId, taskId , commentId)',
  })
  @IsString()
  sortBy: string = 'attachmentId';
