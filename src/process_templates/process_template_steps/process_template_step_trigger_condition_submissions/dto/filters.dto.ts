...
/**
 * Filters for process template step trigger condition submissions listing
 * (system_table catalog: `process_template_step_trigger_condition_submissions`).
 */
export class FiltersDto extends CatalogDynamicListFiltersMixin {
  /**
   * Step Trigger Condition ID is mandatory scope for this listing.
   */
  @Type(() => Number)
  @IsNumber()
