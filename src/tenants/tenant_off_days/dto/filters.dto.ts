...
export class FiltersDto {
   ...
   * Optional field, defaults to 'tenantOffDayId'.
   * Must be one of 'tenantOffDayId', 'tenantId'.
   */
  @IsOptional()
  @IsIn(['tenantOffDayId', 'tenantId'], {
    message: 'sortBy key must be from this list (tenantOffDayId, tenantId)',
  })
  @IsString()
