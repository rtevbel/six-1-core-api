...
export const MICROSERVICE_FIND_ALL_TENANT_USERS_PATTERN =
  'v0.1_find_all_tenant_users';
export const MICROSERVICE_FIND_ONE_TENANT_USER_PATTERN =
  'v0.1_find_one_tenant_user';
export const MICROSERVICE_UPDATE_TENANT_USER_PATTERN =
  'v0.1_update_tenant_user';
export const MICROSERVICE_REMOVE_TENANT_USER_PATTERN =
