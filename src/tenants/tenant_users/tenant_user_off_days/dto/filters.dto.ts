...
export class FiltersDto {
   ...
   * Optional field, defaults to 'tenant_user_off_day_id'.
   * Must be one of 'tenant_user_off_day_id', 'tenant_user_id'.
   */
  @IsOptional()
  @IsIn(['tenant_user_off_day_id', 'tenant_user_id'], {
    message:
      'sortBy key must be from this list (tenant_user_off_day_id, tenant_user_id)',
  })
  @IsString()
  sortBy: string = 'tenant_user_off_day_id';
