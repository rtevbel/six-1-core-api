...
export class FiltersDto {
   ...
   * Optional field, defaults to 'tenantUserWorkingHourId'.
   * Must be one of 'tenantUserWorkingHourId', 'tenantUserId'.
   */
  @IsOptional()
  @IsIn(['tenantUserWorkingHourId', 'tenantUserId'], {
    message:
      'sortBy key must be from this list (tenantUserWorkingHourId, tenantUserId)',
  })
  @IsString()
