...
export class FiltersDto {
   ...
   * Optional field, defaults to 'tenantTypeId'.
   * Must be one of 'tenantTypeId', 'name', or 'description'.
   */
  @IsOptional()
  @IsIn(['tenantTypeId', 'name', 'description'], {
    message:
      'sortBy key must be from this list (tenantTypeId, name, description)',
  })
  @IsString()
