...
export class FiltersDto {
   ...
   * Optional field, defaults to 'requirementSubmissionId'.
   * Must be one of 'requirementSubmissionId', 'requirementInstanceId'.
   */
  @IsOptional()
  @IsIn(['requirementSubmissionId', 'requirementInstanceId'], {
    message:
      'sortBy key must be from this list (requirementSubmissionId, requirementInstanceId)',
  })
  @IsString()
