...
const providerFactory: Provider = {
  ...
  useFactory: (cfg: ConfigService) => {
    ...
    return new LocalProvider({
      ...
      publicBaseUrl: cfg.get<string>(LOCAL_PUBLIC_BASE_URL, "http://localhost:3000/static"), // Public base URL for accessing files.
    });
  },
};
...
@Module({
  ...
  controllers: [/* optional */], // Add controllers if needed.
})
