import type { ConfigCustomObjectInstanceStatus } from './entities/config_custom_object_instance.entity';
...
/**
 * Evaluates completion_rule against resolved core-linked fields (sor_bound / system_table).
 */
export function evaluateCoreLinkedCompletionRule(
  rule: Record<string, unknown> | null | undefined,
  ...
  if (!payloadHasContent(fields ?? {})) {
    return { valid: false, error: 'Required fields are empty' };
  }
