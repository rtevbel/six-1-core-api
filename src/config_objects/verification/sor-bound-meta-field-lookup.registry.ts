...
export interface SorBoundMetaFieldLookupDescriptor {
  metaEntity: Function;
...
const SOR_BOUND_META_FIELD_LOOKUP: Partial<
  Record<string, SorBoundMetaFieldLookupDescriptor>
> = {
  project: {
...
export function getSorBoundMetaFieldLookupDescriptor(
  ...
  return SOR_BOUND_META_FIELD_LOOKUP[objectType] ?? null;
}
